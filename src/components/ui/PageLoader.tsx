    ...
    <div className="flex flex-col items-center justify-center py-24 px-6 w-full animate-fade-in">
      <div className="w-full max-w-xs space-y-4">
        <div className="flex items-center justify-between">
          <span className="text-[10px] font-black text-accent-orange uppercase tracking-[0.3em] animate-pulse">Initializing Node</span>
          <span className="text-[9px] font-mono text-text-light-secondary opacity-40 uppercase tracking-tighter">Status: Fetching</span>
        </div>
        ...
        <p className="text-[8px] text-center text-text-light-secondary opacity-30 uppercase tracking-[0.2em]">
